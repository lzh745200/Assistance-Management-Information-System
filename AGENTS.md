...
python -m pytest tests/ -v --tb=short -q --timeout=60   # Run all tests (10043)
...
npm run test -- --run                                   # Run all tests (1997, 157 test files)
...
- Minimum: 50% (CI gate via `--cov-fail-under=50`)

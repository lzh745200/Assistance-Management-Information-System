...
_DEFAULT_POLICIES = [
    {
        ...
        "enabled": True,
        "severity": "high",
        "conditions": {"min_length": 8, "require_uppercase": True, "require_lowercase": True, "require_digit": True, "require_special": True},
    ...
    },
    {
        ...
        "enabled": True,
        "severity": "high",
        "conditions": {"max_attempts": 10, "lockout_duration_minutes": 30},
    ...
    },
    {
        ...
        "enabled": True,
        "severity": "medium",
        "conditions": {"idle_timeout_minutes": 30, "absolute_timeout_hours": 8},
    ...
    },
    {
        ...
        "enabled": False,
        "severity": "medium",
        "conditions": {"allowed_ips": [], "block_on_violation": True},
        "actions": ["block_connection", "notify_admin"],
    },
    {
        "id": "ztp-005",
        "name": "敏感操作审计",
        ...
        "enabled": True,
        "severity": "medium",
        "conditions": {"operations": ["export", "delete", "config_change", "user_create"]},
        "actions": ["log_operation", "notify_security"],
    },
    {
        "id": "ztp-006",
        "name": "数据访问最小权限",
        ...
        "enabled": True,
        "severity": "high",
        "conditions": {"enforce_data_scope": True, "scope_levels": ["self", "unit", "subordinate", "all"]},
        "actions": ["verify_data_scope", "block_unauthorized_access"],
    },
    {
        "id": "ztp-007",
        "name": "机器码绑定验证",
        ...
        "actions": ["verify_machine_code", "reject_unbound_device"],
    },
    {
        "id": "ztp-008",
        "name": "数据传输加密",
        ...
        "enabled": True,
        "severity": "high",
        "conditions": {"encrypt_packages": True, "min_encryption_level": "AES-256"},
        "actions": ["encrypt_data", "verify_integrity"],
    },
]
...
async def get_security_event_stats(current_user=Depends(get_current_user)):
    ...
    return {
        ...
        "data": {
            ...
            "by_type": by_type,
            "security_posture": "warning" if high_severity_count > 5 else "normal" if high_severity_count > 0 else "secure",
        },
    }

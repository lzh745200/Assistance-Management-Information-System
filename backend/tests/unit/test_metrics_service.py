...
class TestMetricsService:
    ...
    def test_get_kpi_dashboard(self, mock_bms_class):
        ...
        mock_instance.get_kpi_summary = AsyncMock(return_value={"total_funds": 100})
        ...
        mock_bms_class.assert_called_once_with(mock_db)
        mock_instance.get_kpi_summary.assert_awaited_once()

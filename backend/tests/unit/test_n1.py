...
def test_n01():from app.services.data_masking_service import DataMaskingService;s=DataMaskingService();assert len(s.mask_phone("18200182001"))==11
...
def test_n06():from app.core.errors import ErrorCode;assert ErrorCode.SUCCESS==200
def test_n07():from app.core.exceptions import BusinessError;assert BusinessError("m").message=="m"

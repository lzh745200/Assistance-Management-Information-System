...
export const batchUpdateSortOrders = (d: any[]) => api.post('/organizations/batch-update-sort', d)
...
export const getChildren = (orgId: number) => api.get(`/organizations/${orgId}/children`)

export const getAncestors = (orgId: number) => api.get(`/organizations/${orgId}/ancestors`)

export const moveOrganization = (orgId: number, data: any) =>
  api.post(`/organizations/${orgId}/move`, data)

export const activateOrganization = (orgId: number) => api.post(`/organizations/${orgId}/activate`)

...
export const schoolsApi = {
  ...
  listScholarshipStudents: (schoolId: number | string, year?: number) =>
    api.get(`/schools/${schoolId}/scholarship-students`, {
  ...
  // ========== 附件管理 ==========
  listAttachments: (schoolId: number | string) => api.get(`/schools/${schoolId}/attachments`),
  ...
  downloadAttachment: (attachmentId: number | string) =>
    api.get(`/schools/attachments/${attachmentId}/download`, {
      responseType: 'blob',
    }),
}

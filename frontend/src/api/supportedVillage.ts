...
export const updateSupportedVillage = (id: number, data: any) => put("/supported-villages/" + id, data);
export const deleteSupportedVillage = (id: number) => del("/supported-villages/" + id);
export const batchDeleteSupportedVillages = (ids: number[]) => post("/supported-villages/batch-delete", { ids });

// ── Import / export ──
export const importSupportedVillages = (file: File) => {
  const fd = new FormData();
  fd.append("file", file);
  return apiRequest({ method: "POST", url: "/supported-villages/import", data: fd, headers: { "Content-Type": "multipart/form-data" } });
};
// blob 响应：触发浏览器下载
...
export const downloadImportTemplate = () =>
  api.get("/supported-villages/import-template", { responseType: "blob" }).then(r => {
...
export const saveYearlySectionData = (villageId: number, year: number, section: string, data: any) =>
  post(`/supported-villages/${villageId}/yearly/${year}/${section}`, data);

// Backward compat aliases
export const saveIncomeData = (v: number, y: number, d: any) => saveYearlySectionData(v, y, "income", d);
export const saveIndustryData = (v: number, y: number, d: any) => saveYearlySectionData(v, y, "industry", d);
export const saveInfrastructureData = (v: number, y: number, d: any) => saveYearlySectionData(v, y, "infrastructure", d);
export const saveEducationData = (v: number, y: number, d: any) => saveYearlySectionData(v, y, "education", d);
export const saveForceInvestmentData = (v: number, y: number, d: any) => saveYearlySectionData(v, y, "force-investment", d);
export const savePartyBuildingData = (v: number, y: number, d: any) => saveYearlySectionData(v, y, "party-building", d);
export const saveMedicalData = (v: number, y: number, d: any) => saveYearlySectionData(v, y, "medical", d);
export const saveConsumptionData = (v: number, y: number, d: any) => saveYearlySectionData(v, y, "consumption", d);
export const saveEmploymentData = (v: number, y: number, d: any) => saveYearlySectionData(v, y, "employment", d);
export const savePopulationData = (v: number, y: number, d: any) => saveYearlySectionData(v, y, "population", d);
...
export const saveSectionData = (villageId: number, section: string, data: any) =>
...
export const uploadSectionAttachment = (villageId: number, section: string, file: File) => {
  const fd = new FormData();
  fd.append("file", file);
  return apiRequest({ method: "POST", url: `/supported-villages/${villageId}/sections/${section}/attachments`, data: fd, headers: { "Content-Type": "multipart/form-data" } });
};
...
export const importSectionData = (villageId: number, file: File) => {
  const fd = new FormData();
  fd.append("file", file);
  return apiRequest({ method: "POST", url: `/supported-villages/${villageId}/sections/import`, data: fd, headers: { "Content-Type": "multipart/form-data" } });
};
...
export const importAllSectionsData = (villageId: number, file: File) => {
  const fd = new FormData();
  fd.append("file", file);
  return apiRequest({ method: "POST", url: `/supported-villages/${villageId}/sections/import-all`, data: fd, headers: { "Content-Type": "multipart/form-data" } });
};

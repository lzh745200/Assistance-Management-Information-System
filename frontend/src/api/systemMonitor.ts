...
export function getDatabaseFileSize(): Promise<{ success: boolean; data: { size_bytes: number; size_mb: number } }> {
  return get<{ success: boolean; data: { size_bytes: number; size_mb: number } }>("/system/monitor/database-size");
}

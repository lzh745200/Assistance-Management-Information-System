...
export interface ChartCardEmits {
  (e: 'chart-click', params: any): void
  (e: 'legend-select-changed', params: { name: string; selected: Record<string, boolean> }): void
  (e: 'data-zoom', params: { start: number; end: number }): void
  (e: 'rendered'): void
}
export interface ChartCardExpose {

...
<style scoped>
.responsive-table-wrapper { width: 100%; }
...
.card-badge { padding: 2px 10px; border-radius: 12px; font-size: 12px; }
.badge-success { background: #e8f5e9; color: #2e7d32; }
.badge-danger { background: #fce4ec; color: #c62828; }
.badge-warning { background: #fff3e0; color: #ef6c00; }
.badge-info { background: #e3f2fd; color: #1565c0; }
.card-body { display: flex; flex-direction: column; gap: 8px; }
.card-field { display: flex; justify-content: space-between; font-size: 14px; }
.field-label { color: #909399; }
.field-value { color: #303133; font-weight: 500; text-align: right; }
.card-actions { margin-top: 12px; padding-top: 12px; border-top: 1px solid #eee; }
.empty-state { text-align: center; padding: 40px; color: #909399; }
.empty-icon { font-size: 32px; display: block; margin-bottom: 8px; }
.table-pagination { display: flex; justify-content: center; margin-top: 16px; }
</style>

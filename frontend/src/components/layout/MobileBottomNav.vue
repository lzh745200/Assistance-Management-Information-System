...
import {
  HomeFilled, Grid, Money, Message, User,
...
.mobile-nav {
  ...
  height: 56px; background: #fff; border-top: 1px solid #e4e7ed;
  padding-bottom: env(safe-area-inset-bottom);
}
.nav-btn {
  display: flex; flex-direction: column; align-items: center; gap: 2px;
  background: none; border: none; padding: 4px 12px; cursor: pointer;
  color: #909399; transition: color .2s; position: relative;
}
.nav-btn.active { color: #1a3c2a; font-weight: 600; }

...
export const GUIZHOU_REGION: CityData[] = [
  ...
  },
  {
    name: "遵义市",
    counties: [
      "红花岗区", "汇川区", "播州区", "桐梓县", "绥阳县", "正安县",
      "道真仡佬族苗族自治县", "务川仡佬族苗族自治县", "凤冈县", "湄潭县",
      "余庆县", "习水县", "赤水市", "仁怀市",
    ],
  },
  {
  ...
  },
  {
    name: "黔东南苗族侗族自治州",
    counties: [
      "凯里市", "黄平县", "施秉县", "三穗县", "镇远县", "岑巩县",
      "天柱县", "锦屏县", "剑河县", "台江县", "黎平县", "榕江县",
      "从江县", "雷山县", "麻江县", "丹寨县",
    ],
  },
  {
...
export const GUIZHOU_ALL_COUNTIES: string[] = GUIZHOU_REGION.flatMap((c) => c.counties);

      ...
      <el-scrollbar>
        ...
        >
          ...
          <el-sub-menu index="village-group">
            <template #title
              ><el-icon><Location /></el-icon><span>帮扶村管理</span></template
            >
          ...
          <el-sub-menu index="project-group">
            <template #title
              ><el-icon><Folder /></el-icon><span>帮扶项目</span></template
            >
          ...
          <el-sub-menu index="fund-group">
            <template #title
              ><el-icon><Money /></el-icon><span>经费管理</span></template
            >
          ...
          <el-sub-menu index="school-group">
            <template #title
              ><el-icon><School /></el-icon><span>帮扶学校</span></template
            >
          ...
          <el-sub-menu index="rural-group">
            <template #title
              ><el-icon><Stamp /></el-icon><span>乡村振兴</span></template
            >
          ...
          <el-sub-menu index="approval-group">
            <template #title
              ><el-icon><Checked /></el-icon><span>审批管理</span></template
            >
          ...
          <el-sub-menu index="datasync-group">
            <template #title
              ><el-icon><Connection /></el-icon><span>数据管理</span></template
            >
...
.layout-header :deep(.el-breadcrumb__inner.is-link:hover) {
  color: #d4af37;
}

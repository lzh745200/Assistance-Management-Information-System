      ...
      <el-row :gutter="20">
        ...
        <el-col :span="12">
          <el-form-item label="帮扶单位">
            <el-input
              v-model="filterForm.support_unit"
              placeholder="请输入帮扶单位"
              clearable
            />
          </el-form-item>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="村庄名称">
            <el-input
              v-model="filterForm.village_name"
              placeholder="请输入村庄名称"
              clearable
            />
          </el-form-item>
        ...
        <el-col :span="12">
          <el-form-item label="地区范围">
            <el-input
              v-model="filterForm.region_scope"
              placeholder="请输入地区范围"
              clearable
            />
          </el-form-item>
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="三区三州">
            <el-select
              v-model="filterForm.is_three_regions"
              placeholder="请选择"
              clearable
            >
        ...
        <el-col :span="12">
          <el-form-item label="边疆地区">
            <el-select
              v-model="filterForm.is_border_area"
              placeholder="请选择"
              clearable
            >
              <el-option label="是" :value="1" />
    ...
    <div v-if="exportTask" class="export-status">
      ...
      <el-descriptions :column="2" border size="small">
        ...
        <el-descriptions-item label="状态">
          <el-tag
            :type="formatExportStatus(exportTask.status).type"
            size="small"
          >
...
async function handleDownload() {
  ...
  try {
    ...
    const filename =
      ...
      `帮扶村数据_${new Date().toISOString().slice(0, 10)}.xlsx`;

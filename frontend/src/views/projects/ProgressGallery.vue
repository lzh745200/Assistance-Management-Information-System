  ...
  <div class="progress-gallery">
    ...
    <el-card class="main-card" shadow="never">
      ...
      <div class="project-info">
        ...
        <el-descriptions :column="3" border>
          <el-descriptions-item label="项目编号">{{ projectData.code }}</el-descriptions-item>
          <el-descriptions-item label="开始时间">{{ projectData.startDate }}</el-descriptions-item>
          <el-descriptions-item label="当前状态">
            <el-tag :type="getStatusType(projectData.status)">{{ projectData.status }}</el-tag>
    ...
    >
      ...
      <div v-else-if="currentViewType === 'image'">
        <img :src="currentViewData?.url" :alt="currentViewData?.title" class="full-image" />
      </div>
      <template #footer>

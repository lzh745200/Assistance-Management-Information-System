  ...
  <div class="system-config-page">
    <div class="page-header">
      ...
      <div class="page-header-right">
        ...
        >
          <el-icon v-if="saveStatus.isSaving.value" class="is-loading"
            ><Loading
          /></el-icon>
          <el-icon v-else-if="saveStatus.isSaved.value" color="#67C23A"
            ><CircleCheck
          /></el-icon>
          <el-icon v-else-if="saveStatus.isError.value" color="#F56C6C"
            ><CircleClose
          /></el-icon>
      ...
      <el-tab-pane label="基础配置" name="basic">
        <el-form :model="basicConfig" label-width="140px" class="config-form">
          ...
          <el-form-item label="普通用户默认首页">
            ...
            <span class="form-tip"
              >设置后普通用户（非管理员）登录将自动进入此页面</span
            >
          </el-form-item>
          <el-form-item label="数据保留天数">
            <el-input-number
              v-model="basicConfig.retentionDays"
              :min="30"
              :max="365"
            />
          </el-form-item>
      ...
      <el-tab-pane label="通知设置" name="notification">
        <el-form :model="notifyConfig" label-width="140px" class="config-form">
          ...
          <el-form-item v-if="notifyConfig.emailEnabled" label="发件人邮箱">
            <el-input
              v-model="notifyConfig.senderEmail"

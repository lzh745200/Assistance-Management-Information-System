      ...
      <div v-else>
        ...
        >
          ...
          <el-form-item label="单位简称">
            <el-input
              v-model="form.organization_short_name"
              placeholder="可选"
            />
          </el-form-item>
          ...
          <el-form-item>
            <el-button type="primary" @click="nextStep(orgFormRef)"
              >下一步</el-button
            >
          </el-form-item>
        </el-form>
        ...
        >
          ...
          <el-form-item>
            ...
            <el-button type="primary" @click="nextStep(adminFormRef)"
              >下一步</el-button
            >
          </el-form-item>
        </el-form>

...
describe('ui/MilitaryBadge.vue', () => { it('渲染', async () => { const { default: C } = await import('@/components/ui/MilitaryBadge.vue'); const w = mount(C); expect(w.exists()).toBe(true) }) })
...
describe('organization/OrganizationForm.vue', () => { it('渲染', async () => { const { default: C } = await import('@/components/organization/OrganizationForm.vue'); const w = mount(C, { props: { modelValue: {} } }); await flushPromises(); expect(w.exists()).toBe(true) }) })
describe('organization/OrganizationTree.vue', () => { it('渲染', async () => { const { default: C } = await import('@/components/organization/OrganizationTree.vue'); const w = mount(C); await flushPromises(); expect(w.exists()).toBe(true) }) })
...
describe('templates/TemplateDownload.vue', () => { it('渲染', async () => { const { default: C } = await import('@/components/templates/TemplateDownload.vue'); const w = mount(C); await flushPromises(); expect(w.exists()).toBe(true) }) })
